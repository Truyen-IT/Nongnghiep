...
<div class="heading">
    ...
    <!-- <p> <a href="{{URL::to('trangchu')}}">TRANG CHỦ >></a> CỬA HÀNG >> @foreach($the_first as $key=> $the)
        {{$the->category_name}}
        @endforeach </p> -->
</div>
...
<section class="products">
    ...
    <h4 class="cim" > <a href="{{URL::to('trangchu')}}">Trang chủ >></a> Danh mục>> @foreach($the_first as $key=> $the)
        {{$the->category_name}}
        @endforeach </h4>
    ...
    <h1 class="title">
        @foreach($the_first as $key=> $the) <span>{{$the->category_name}}</span>@endforeach
    ...
    <div class="row ">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <form action="">
                    @csrf
                    <select name="sorf" id="sorf" class="form-control input-sm m-bot15 select-filter">
                        <option value="{{Request::url()}}?sort_by=none">-------Thứ tự mặc định-------</option>
                        
                        <option value="{{Request::url()}}?sort_by=az">Thứ tự theo thứ tự A - Z</option>
                        <option value="{{Request::url()}}?sort_by=za">Thứ tự theo thứ tự Z -A</option>
