        ...
        <form>
            ...
            <div class="row container">
                ...
                <div class="col-sm-4">
                    ...
                    <h2 class="text-2">Giá:{{number_format($de->product_price).'.VND'}}.</h2>
                    <div class="row  text4">
                    ...
                    <button type="button" class="btn btn-outline-success btn-lg cart add-to-cart"
                        data-id_product="{{$de->product_id}}">
...
<section class="products">
 ...
 src="{{URL::to('upload/'.$pro->product_image)}}" alt="">
                </div>
                <div class="content">
